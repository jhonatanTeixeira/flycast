...
sh4_opcodelistentry opcodes[]=
{
   ...
   {dec_i0000_0000_0000_1001   ,i0000_0000_0000_1001   ,Mask_none      ,0x0000 ,Normal         ,"nop0"                                 ,1,0,MT,fix_none}   ,//nop0 Looney Tunes: Space Race, Samba de Amigo 2000
	...
	{dec_i0100_nnnn_0110_0110  ,i0100_nnnn_0110_0110   ,Mask_n         ,0x4066 ,FWritesFPSCR   ,"lds.l @<REG_N>+,FPSCR"                ,1,1,CO,fix_none},  //lds.l @<REG_N>+,FPSCR -- native mov+sync_fpscr+forced block end, see docs/fpscr_native_translation_plan.md
	...
	{dec_i0100_nnnn_0110_1010  ,i0100_nnnn_0110_1010   ,Mask_n         ,0x406A ,FWritesFPSCR   ,"lds <REG_N>,FPSCR"                    ,1,1,CO,fix_none},  //lds <REG_N>,FPSCR -- native mov+sync_fpscr+forced block end, see docs/fpscr_native_translation_plan.md
